...
public class Viewanimals  implements ActionListener
{
JFrame f1;
JPanel P1;
JButton b1,b2,tab2;
...
JTextField t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t12,t13;
	...
	public void frame1()
    {
	 f1=new JFrame();
			f1.setSize(800,800);
			f1.setVisible(true);
			f1.setTitle("  VIEW ANIMALS DETAILS");
				...
				P1.setBackground(Color.gray);
		         ...
		         Label l1=new Label(" VIEW ANIMALS DETAILS");
...
//			
	...
	try
		...
		Connection  con=DriverManager.getConnection("jdbc:mysql://localhost:3306/zoo","root","");
			...
			String vaccine;
			String arrivaldate;
			String  id1=null,name1=null,type1=null, species1=null,gender1=null,
age1=null,vaccine1=null, arrivaldate1=null;
			 while (r.next())
			 {
...
f1.setVisible(false);	}
	...
	{
		 Animaltable st = new  Animaltable();
			st.atabel();
