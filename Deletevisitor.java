...
public class Deltetvisitor  implements ActionListener
{
JFrame f1;
JPanel P1;
JButton b1,b2;
	 ...
	 f1=new JFrame();
			...
			f1.setTitle("DELETE  VISITOR");
				...
				P1.setBackground(Color.gray);
		         ...
		         JLabel l1=new JLabel("DELETE VISITOR");
	...
	public void butt3()
		...
		public void actionPerformed(ActionEvent e)
				...
				
					{
						...
						String s1="delete from visitor where no ='"+t1.getText()+"'";
